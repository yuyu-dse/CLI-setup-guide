...
This guide explains how to set up and configure OpenCode natively on Windows.
...
> OpenCode recommends WSL for the best Windows compatibility. This guide is specifically for native Windows setup.
